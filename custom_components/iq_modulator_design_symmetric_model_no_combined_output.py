    ...
    class Layout(i3.LayoutView):
        ...
        def _generate_instances(self, insts):
            ...
            instances = {
                ...
                #'combiner_main': self.combiner,        # no combiner modificaiton
        ...
        def _generate_ports(self, ports):
            ...
            ports += i3.expose_ports(self.instances, {'top_output_phase_shifter:out': 'top_out'})
            ports += i3.expose_ports(self.instances, {'bottom_output_phase_shifter:out': 'bottom_out'})
