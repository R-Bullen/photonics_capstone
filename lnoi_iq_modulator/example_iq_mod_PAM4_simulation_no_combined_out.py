...
from simulation.simulate_iq_mod_PAM4_no_combiner import simulate_modulation_PAM4, result_modified_PAM4
...
rf_vpi = cm.vpi_l / 2 / (electrode_length / 1e4)  # VpiL unit is V.cm; Dividing be 2 is due to push-pull configutation
V_half_pi = rf_vpi / 2
