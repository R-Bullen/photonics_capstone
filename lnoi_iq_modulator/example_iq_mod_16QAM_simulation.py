...
from simulation.simulate_iq_mod_QAM import simulate_modulation_QAM, result_modified_QAM
...
plt.figure(4)
res = result_modified_QAM(results, samples_per_symbol=samples_per_symbol, sampling_point=0.9)
