...
from custom_components.iq_modulator_design import CPWElectrodeWithWaveguides
from simulation_2.iq_mod_scripts.simulation.simulate_dual_mzm_BPSK import (result_modified_BPSK_1, simulate_dual_mzm_BPSK,
                                                                           result_modified_BPSK_2, result_modified_BPSK_3, result_modified_BPSK_4)
...
dual_mzm = CPWElectrodeWithWaveguides()
...
results = simulate_dual_mzm_BPSK(
    cell=dual_mzm,
    mod_amplitude_i=3.0,
    mod_noise_i=0.0,
    mod_amplitude_q=3.0,
...
plt.figure(6)
res = result_modified_BPSK_2(results)
