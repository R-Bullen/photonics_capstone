...
from simulation.sim_functions.simulate_iqmodulator import simulate_modulation_iqmod, result_modified_PAM4
import numpy as np
...
results = simulate_modulation_iqmod(
    cell=iq_mod,
    mod_amplitude_i=rf_vpi / 2 * 0.5,
    mod_noise_i=0.01,
    mod_amplitude_q=rf_vpi / 2 * 0.5,
    mod_noise_q=0.01,
    opt_amplitude=1.0,
    opt_noise=0.01,
    v_heater_i=0.1,
