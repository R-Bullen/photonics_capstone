...
from simulation.benches.sources_extra import random_bitsource, rand_normal, rand_sq_bitsource
...
def simulate_modulation_PAM4(
    ...
    signal = i3.FunctionExcitation(
        ...
        port_domain=i3.ElectricalDomain, excitation_function=lambda t: f_mod_3(t)
    )
...
def result_modified_ASK(result, samples_per_symbol, sampling_point=0.5):
